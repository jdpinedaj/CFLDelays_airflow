...
DROP TABLE IF EXISTS cfl.public_ready_for_ML.train_data;
CREATE TABLE IF NOT EXISTS cfl.public_ready_for_ML.train_data AS
SELECT train_data_final.*,
    ...
    commentaire,
    (
        COALESCE(tare_weight_0, 0) + COALESCE(tare_weight_1, 0) + COALESCE(tare_weight_2, 0) + COALESCE(tare_weight_3, 0) + COALESCE(tare_weight_4, 0) + COALESCE(tare_weight_5, 0) + COALESCE(tare_weight_6, 0) + COALESCE(tare_weight_7, 0) + COALESCE(tare_weight_8, 0) + COALESCE(tare_weight_9, 0) + COALESCE(tare_weight_10, 0) + COALESCE(tare_weight_11, 0) + COALESCE(tare_weight_12, 0) + COALESCE(tare_weight_13, 0) + COALESCE(tare_weight_14, 0) + COALESCE(tare_weight_15, 0) + COALESCE(tare_weight_16, 0) + COALESCE(tare_weight_17, 0) + COALESCE(tare_weight_18, 0) + COALESCE(tare_weight_19, 0) + COALESCE(tare_weight_20, 0) + COALESCE(tare_weight_21, 0) + COALESCE(tare_weight_22, 0) + COALESCE(tare_weight_23, 0) + COALESCE(tare_weight_24, 0) + COALESCE(tare_weight_25, 0) + COALESCE(tare_weight_26, 0) + COALESCE(tare_weight_27, 0) + COALESCE(tare_weight_28, 0) + COALESCE(tare_weight_29, 0) + COALESCE(tare_weight_30, 0) + COALESCE(tare_weight_31, 0) + COALESCE(tare_weight_32, 0) + COALESCE(tare_weight_33, 0) + COALESCE(tare_weight_34, 0) + COALESCE(tare_weight_35, 0)
    ) AS train_tare_weight
FROM cfl.public_processed.train_data_final
    LEFT JOIN cfl.public_processed.incident_data ON cfl.public_processed.train_data_final.idtrain_lot = cfl.public_processed.incident_data.id_train_lot;
--! CREATING data related to trains and wagons
DROP TABLE IF EXISTS cfl.public_ready_for_ML.data1_trains_wagons;
CREATE TABLE IF NOT EXISTS cfl.public_ready_for_ML.data1_trains_wagons AS (
    SELECT id_train,
        lot_num_data_init,
        nom_lot_data_init,
        journey_distance,
        ...
        id_train_origin,
        id_gare_origin,
        jalon_passage_origin,
        h_depart_ecart_origin,
        h_arrivee_ecart_origin,
        id_utilisateur_creation_origin,
        dateh_creation_origin,
        id_utilisateur_maj_origin,
        dateh_maj_origin,
        commentaire_origin,
        distance_origine_origin,
        h_arrivee_ecart1_origin,
        h_arrivee_ecart2_origin,
        h_depart_ecart1_origin,
        h_depart_ecart2_origin,
        dho_depart_origin,
        dho_arrivee_origin,
        code_uic_station_origin,
        id_gare_station_origin,
        code_station_origin,
        nom_station_origin,
        origin_station,
        origin_country,
        id_gare_parent_station_origin,
        gare_frontiere_station_origin,
        origin_latitude,
        origin_longitude,
        id_utilisateur_creation_station_origin,
        dateh_creation_station_origin,
        id_utilisateur_maj_station_origin,
        dateh_maj_station_origin,
        type_gare_station_origin,
        top_everysens_existe_station_origin,
        geojson_station_origin,
        id_train_jalon_destination,
        jalon_num_destination,
        actual_arrival,
        planned_arrival,
        arrive_variance,
        dht_depart_destination,
        dhr_depart_destination,
        id_train_destination,
        id_gare_destination,
        jalon_passage_destination,
        h_depart_ecart_destination,
        h_arrivee_ecart_destination,
        id_utilisateur_creation_destination,
        dateh_creation_destination,
        id_utilisateur_maj_destination,
        dateh_maj_destination,
        commentaire_destination,
        distance_origine_destination,
        h_arrivee_ecart1_destination,
        h_arrivee_ecart2_destination,
        h_depart_ecart1_destination,
        h_depart_ecart2_destination,
        dho_depart_destination,
        dho_arrivee_destination,
        code_uic_station_destination,
        id_gare_station_destination,
        code_station_destination,
        nom_station_destination,
        destination_station,
        destination_country,
        id_gare_parent_station_destination,
        gare_frontiere_station_destination,
        destination_latitude,
        destination_longitude,
        id_utilisateur_creation_station_destination,
        dateh_creation_station_destination,
        id_utilisateur_maj_station_destination,
        dateh_maj_station_destination,
        type_gare_station_destination,
        top_everysens_existe_station_destination,
        geojson_station_destination,
        origin_city_country,
        ...
        late_departure_bin,
        late_arrival_bin,
        late_departure_bin_15,
        late_arrival_bin_15,
        actual_departure_bin,
        actual_arrival_bin,
        bb_departure_bin,
        ...
        commentaire,
        train_tare_weight
    FROM cfl.public_ready_for_ML.train_data
);
--! CREATING data related to stations
DROP TABLE IF EXISTS cfl.public_ready_for_ML.data2_stations;
CREATE TABLE IF NOT EXISTS cfl.public_ready_for_ML.data2_stations AS (
    SELECT id_train,
...
--! CREATING data_final
DROP TABLE IF EXISTS cfl.public_ready_for_ML.df_final_for_ml;
CREATE TABLE IF NOT EXISTS cfl.public_ready_for_ML.df_final_for_ml AS WITH data_station_1 AS (
    SELECT id_train,
    ...
    FROM cfl.public_ready_for_ML.data2_stations
),
data_station_2 AS (
    SELECT id_train,
...
SELECT cfl.public_ready_for_ML.data1_trains_wagons.*,
    Station_Name_dep,
    Station_Name_arriv,
    Plan_Timestamp_dep,
