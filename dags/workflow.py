...
dag = DAG(
    dag_id="CFL_delay_prediction_v2",
...
with TaskGroup(
    ...
    create_public_schema >> [
        create_incident_concerne_table,
        create_incidents_table,
        create_station_table,
        create_terminal_table,
        create_train_etape_table,
        create_train_jalon_table,
        create_train_lot_table,
        create_train_position_table,
        create_train_wagon_table,
        create_train_table,
        create_wagon_capacite_table,
        create_wagon_position_table,
        create_wagon_table,
        create_wagon_modele_table,
        create_stations_countries_table,
    ]
...
with TaskGroup(
    ...
    [
        populate_incident_concerne_table,
        populate_incidents_table,
        populate_station_table,
        populate_terminal_table,
        populate_train_etape_table,
        populate_train_jalon_table,
        populate_train_lot_table,
        populate_train_position_table,
        populate_train_wagon_table,
        populate_train_table,
        populate_wagon_capacite_table,
        populate_wagon_position_table,
        populate_wagon_table,
        populate_wagon_modele_table,
...
with TaskGroup(
    ...
    create_public_processed_schema >> [
        preprocess_incident_concerne_table,
        preprocess_incidents_table,
        preprocess_station_table,
        preprocess_train_etape_table,
        preprocess_train_jalon_table,
        preprocess_train_lot_table,
        preprocess_train_position_table,
        preprocess_train_table,
...
with TaskGroup(
    ...
    joining_tables >> [
        check_incident_data_table,
        check_station_data_final_table,
        check_train_data_final_table,
        check_wagon_data_table,
    ]
